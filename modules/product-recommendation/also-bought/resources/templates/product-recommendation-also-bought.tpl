<script type="template/klevu" id="klevuLandingTemplateAlsoBought">
    <div class="kuProductRecommendationSlider kuRecommendationAlsoBought" data-section="alsoBoughtProductList">

        <div class="klevuRecs">
            <h3>Also Bought Products</h3>
        </div>

        <% var alsoBoughtProductList = klevu.getObjectPath(data,"query.alsoBoughtProductList.result");%>
        <% if(alsoBoughtProductList && alsoBoughtProductList.length) { %>
            ...
            <div class="klevuRecs">
                ...
                <div class="klevuRecsResults">
                    <div class="klevuRecsResultsInner" style="left: 0px;">
                        ...
                        <% helper.each(alsoBoughtProductList, function(key, product){ %>
