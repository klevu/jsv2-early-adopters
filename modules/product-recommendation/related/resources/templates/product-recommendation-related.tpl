<script type="template/klevu" id="klevuRelatedProductsTemplate">
    <div class="kuProductRecommendationSlider kuRecommendationRelated" data-section="relatedProductList">
        
        <div class="klevuRecs">
            <h3>Related Products</h3>
        </div>

        <% var relatedProductList = klevu.getObjectPath(data,"query.relatedProductList.result");%>
        <% if(relatedProductList && relatedProductList.length) { %>
            ...
            <div class="klevuRecs">
                ...
                <div class="klevuRecsResults">
                    <div class="klevuRecsResultsInner" style="left: 0px;">
                        ...
                        <% helper.each(relatedProductList, function(key, product){ %>
