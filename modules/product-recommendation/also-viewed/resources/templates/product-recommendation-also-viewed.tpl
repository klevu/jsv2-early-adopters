<script type="template/klevu" id="klevuAlsoViewedProductsTemplate">
    <div class="kuProductRecommendationSlider kuRecommendationAlsoViewed" data-section="alsoViewedProductList">
        
        <div class="klevuRecs">
            <h3>Also Viewed Products</h3>
        </div>

        <% var alsoViewedProductList = klevu.getObjectPath(data,"query.alsoViewedProductList.result");%>
        <% if(alsoViewedProductList && alsoViewedProductList.length) { %>
            ...
            <div class="klevuRecs">
                ...
                <div class="klevuRecsResults">
                    <div class="klevuRecsResultsInner" style="left: 0px;">
                        ...
                        <% helper.each(alsoViewedProductList, function(key, product){ %>
