...
/**
 * Override landing chains for Category Navigation
 */
    ...
    fire: function () {
        ...
        klevu.search.landing.getScope().chains.request.build.add({
            ...
            fire: function (data, scope) {
                ...
                productList.settings.query.term = "*";
                productList.settings.query.categoryPath = categoryPath;
                ...
                data.context.isCATNAV = true;
                data.context.categoryPath = categoryPath;
            }
        });
    }
});
                ...
                klevu.event.attach(value, "click", function (event) {
                    ...
                    if (productId) {
                        ...
                        if (product) {
                            ...
                            categoryOptions.klevu_productName = product.name;
                            categoryOptions.klevu_productUrl = product.url;
                            categoryOptions.klevu_src = "[[shortlist:add-to-cart;;template:category]]";
                            categoryOptions.klevu_productSku = product.sku;
                            categoryOptions.klevu_salePrice = product.salePrice;
                            categoryOptions.klevu_productRatings = product.rating;
                            categoryOptions.klevu_productPosition = categoryOptions.klevu_pageStartsFrom;
...
/**
 * Promotional Banner module for Category Navigation
 */
klevu.coreEvent.attach("setRemoteConfigLanding", {
    ...
    fire: function () {
        ...
        klevu.search.landing.getScope().chains.template.process.success.add({
            ...
            fire: function (data) {
                var catNavBannerList = klevu.search.modules.promotionBanner.base.getCategoryPageBanners();
                if (catNavBannerList && catNavBannerList.length) {
                    ...
                    klevu.each(catNavBannerList, function (index, value) {
                        if (value.hasOwnProperty("showForTerms")) {
                            if (value.showForTerms == null) {
                                ...
                                klevu.each(value.showForTerms, function (i, term) {
                                    var recordQueries = klevu.getObjectPath(data.request, 'settings.object.recordQueries');
                                    recordQueries.forEach(function (recordQuery) {
                                        var categoryPath = klevu.getObjectPath(recordQuery, 'settings.query.categoryPath');
                                        if (categoryPath && categoryPath.toLowerCase() == term.toLowerCase()) {
...
/**
 * Event to fire catnav search request
 */
klevu.coreEvent.attach("setRemoteConfigLanding", {
    name: "search-landing-init",
    fire: function () {
        if (klevu.dom.find(".klevuLanding").length) {
            ...
            klevu.setSetting(klevu.search.landing.getScope().settings, "settings.search.categoryPath", klevu_pageCategory);
            klevu.setSetting(klevu.search.landing.getScope().settings, "settings.search.categoryFilters", klevu_userLandingFilterResults);
